...
def main():
    ...
    Ball.paddle_sound = pygame.mixer.Sound("mp3/button02a.mp3")    # パドルにボールが衝突した時の効果音取得
    Ball.block_sound = pygame.mixer.Sound("mp3/button01a.mp3")    # ブロックにボールが衝突した時の効果音取得
    Ball.gameover_sound = pygame.mixer.Sound("mp3/button01b.mp3")    # ゲームオーバー時の効果音取得
    ...
    Ball("img/ball.png", paddle, blocks, score) # ボールを作成
